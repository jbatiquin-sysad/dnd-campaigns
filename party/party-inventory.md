...
> **Hook:** Update this file whenever the party acquires, spends, consumes, or stores shared resources (gold, rations, potions, materials, documents, transport passes).
...
| Darkvision | 2 | 0 |
| Ward-circuit ink (applications) | 7 | 0 |
...
|----------|-------|--------|
| 8x Duskport Letters of Credential | Authorized agents, Duskport inquiry | Active |
| 8x Harrowgate commendation letters | Kellan | Active |
| 8x Greymoor commendation letters | Kess + Sister Maren + Chapel seal | Active |
| 8x Salthollow commendation letters | Ashworth + Fell | Active |
...
## Evidence Archive (Sylvara carrying)

| Document | Origin | Status |
|----------|--------|--------|
| Venn's operational journal (200+ pages) | Veldmere compound | Complete network map |
| Blackveil's operational ledger | Greymoor | Mining/excavation records |
| Vane's acquisition ledger | Salthollow | Property seizure records |
| Senn's handler correspondence (decoded) | Salthollow | All 6 handler profiles |
| Assembly notes (ward-inversion procedure) | Veldmere | Technical reference |
| 3x regional civic charters + master index | Athenaeum, Salthollow | Pre-Sundering, legally binding |
...
## Homestead — Dawnwatch Homestead, Fenhollow

| Category | Details |
|----------|---------|
| Location | Fenhollow inland rise, 20 min from village |
| Size | 4 acres |
