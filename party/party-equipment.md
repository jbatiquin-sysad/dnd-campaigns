...
**Armor:** Chain mail + steel shield (AC 19 — base 16 + shield 2 + Defense 1)
**Weapon:** Well-made longsword
...
**Armor:** Reinforced leather (AC 15)
**Weapons:** Short sword, light crossbow, hand crossbow
**Clothing:** Fitted dark travelling outfit, grey cloak (infiltration)

| Slot | Item | Notes |
|------|------|-------|
| Ring | Dawnwatch signet ring (M) — ENCHANTED | Ward-network attuned, resonance pulse |
| Neck | Abjuration amulet (attuned) | Suppresses detection magic |
...
**Armor:** Chain mail + shield (AC 18)
**Weapon:** Warhammer
**Clothing:** Acolyte underlayer robes

| Slot | Item | Notes |
|------|------|-------|
| Ring | Dawnwatch signet ring (A) — ENCHANTED | Ward-network attuned, resonance pulse |
...
| Slot | Item | Notes |
|------|------|-------|
| Ring | Dawnwatch signet ring (S) — ENCHANTED | Ward-network attuned, resonance pulse |
...
**Armor:** Chain shirt (AC 15)
**Weapons:** Quarterstaff, hand axe, dagger
**Clothing:** Military-cut travelling coat, resoled boots

| Slot | Item | Notes |
|------|------|-------|
| Ring | Dawnwatch signet ring (B) — ENCHANTED | Ward-network attuned, resonance pulse |
| Carried | Spellbook | |
| Belt | Spell component pouch | |
| Pack | Woodcarving kit | Gouges, chisels, drawknife, sharpening stone |
| Pack | Military insignia | Old unit |
| Pocket | 3 steel ingots | Party materials |
...
| Ring (R) | House Ironveil signet ring | Polished |
| Belt | Thieves' tools | |
| Pack | Grey cloak (infiltration) | |
| Pack | Crossbow bolts | Full (restocked Aelindra) |
...
| Slot | Item | Notes |
|------|------|-------|
| Ring | Dawnwatch signet ring (O) — ENCHANTED | Ward-network attuned, resonance pulse |
| Neck | Holy symbol | |
| Belt | Crowbar | |
| Pack | Healer's Kit | |
| Pack | Mining lantern | |
...
**Armor:** Studded leather (AC 15 — reinforced by Thessaly)
**Weapons:** Short sword, driftwood flute
**Clothing:** Full outfit (shirt, trousers, vest, cloak)

| Slot | Item | Notes |
|------|------|-------|
| Ring | Dawnwatch signet ring (P) — ENCHANTED | Ward-network attuned, resonance pulse |
