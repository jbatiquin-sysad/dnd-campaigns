...
| **U2** | Greymoor Deep Shafts | E5 | Medium (600+ ft) | ⚠️ KNOWN — Shaft 9 sealed door | Donal Crewe (S4) | Shaft 9 at 600 ft — sealed door found by Donal 5 months before party arrived. Never opened. Mining tunnels may intersect natural caverns. Greymoor miners report "singing from the ground" (louder since node repairs). **Node 14 (The Ember Vein) confirmed beneath the Greypeaks via Vaelen's map.** **Sealed iron door confirmed from BELOW (Day 141, 1249 AS). Y Fork right branch → Crucible → right tunnel → Shaft 9. Door can be opened from mining side by Donal Crewe.** |
