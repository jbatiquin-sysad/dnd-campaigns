...
|---|------|-------------|-----------|--------|--------|-------|
| **U1** | The Undercroft (Duskport) | K12 | Shallow (50–200 ft) | ⚠️ KNOWN — partially explored S1 | Party (S1) | Pre-Sundering complex beneath Duskport. Hollow Court origin. Repository opened by Dawnwatch. Deeper levels unexplored. Voss's inquiry aware. Possible deeper connections. |
...
| **U3** | Ashenmere Catacombs (Lower Vault) | F4 | Shallow–Medium | ⚠️ KNOWN — sealed, garrison posted | Cole (S5) | Sealed vault beneath the ruined temple. Heartstone (1/7) discovered. Lower levels unexplored. The Order of the Ashen Veil built above something older. |
