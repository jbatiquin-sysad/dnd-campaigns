# Underdark Map — Known & Suspected Entrances

> **Status:** PRELIMINARY — compiled from Dawnwatch investigation, Day 169+
> **Hook:** Update this file as entrances are confirmed, explored, or sealed.

---

## Overview

The Underdark beneath the Hearthcoast is poorly documented on the surface. Pre-Sundering records (Archive, Vigil Field Manual) reference deep structures, but most surface-dwellers have no direct knowledge. The Dawnwatch's investigation draws on: Vaelith's ancient memory, Sylvara's Archive research, Torven's geological analysis, Seren's western coast observations, Zaryth's personal knowledge as a Drow exile, and field intelligence from the inter-city network.

**Key discovery (Day 10, 1249 AS — Aelindra Corridor 3 map room):** The 9 Binding-era anchor stations are connected by an underground tunnel network — the **Deep Road system**. This is not a single tunnel but a branching network linking all 9 stations through the Underdark. At the center of the network, deeper than everything else: an unmarked point — the **source** of the Binding frequency, located beneath the Old Foundation (Fenhollow Marshes, 540+ ft depth).

**Key principle (Vaelith):** "The Underdark is not a place. It is a *layer*. Everywhere you stand, it is beneath you. The question is only where the doors are."
...
| # | Name | Surface Hex | Depth Est. | Status | Source | Notes |
|---|------|-------------|-----------|--------|--------|-------|
| **U1** | The Undercroft (Duskport) | K12 | Shallow (50–200 ft) | ✅ **CONNECTED Day 117, 1257 AS** — Southern Deep Road linked to U1 via Duskport Junction | Party (S1) + Apprentice expedition (S15) | Pre-Sundering complex beneath Duskport. Hollow Court origin. Repository opened by Dawnwatch. **Duskport Junction discovered Day 117, 1257:** vaulted chamber at -400 ft, 4 passages (N→Fenhollow 23 mi, E→U1 upper levels, S→sealed passage under harbor toward Veldmere, W→dead-end storage). Keeper Aldwyn's journal confirms 63-mile Binder-era route to Veldmere via basalt tube under sea floor. Sealed southern passage = future expedition target. Binder waymarkers throughout. |
| **U2** | Greymoor Deep Shafts | E5 | Medium (600+ ft) | ✅ **OPENED Day 44, 1257 AS** — Shaft 9 door opened both sides | Donal Crewe (S4) + Zaryth (S14) | Shaft 9 at 600 ft — sealed door opened Day 44, 1257 (Donal Crewe from above, Zaryth resonance key from below). **THRESHOLD CHAIN OPERATIONAL:** Vel'tarn → Crucible (instant) → rail cart 4mi 45min → lift 15min → Greymoor surface. ~1 hour total. Year-round. Tunnel cleared, ward-lit, rail system installed. Binder side chamber discovered (~800 BS tools + maintenance log). Deep deposits: iron (600ft), silver-quartz (650ft), unknown mineral (780ft). **Node 14 (The Ember Vein) confirmed beneath the Greypeaks via Vaelen's map.** || **U3** | Ashenmere Catacombs (Lower Vault) | F4 | Shallow–Medium | ⚠️ KNOWN — sealed, garrison posted | Cole (S5) | Sealed vault beneath the ruined temple. Heartstone (1/7) discovered. Lower levels unexplored. The Order of the Ashen Veil built above something older. |
| **U15** | Aelindra Sub-Level 3 (Keeper Station) | N5 | Medium | ✅ **ACCESSED Day 5, 1249 AS** — station repaired to 58% | Veyra Solund / Party | Second Binding-era keeper station. Circular chamber, column, 8 pedestals. Map room discovered (Corridor 3) — full Deep Road infrastructure map. 2 corridors still sealed. |

---

## Suspected Entrances (High Confidence)

| # | Name | Surface Hex | Depth Est. | Confidence | Source | Notes |
|---|------|-------------|-----------|------------|--------|-------|
| **U4** | Greypeak Pass Caverns | E3 | Medium–Deep | High | Vaelith, geological | The Greypeaks are riddled with natural caverns. The pass itself cuts through limestone — classic Underdark geology. Reavers (10–15 bandits) camp near the pass; they may use cave systems for shelter. Vaelith: "The mountains are hollow. They always were." |
...
## Suspected Entrances (Medium Confidence)

| # | Name | Surface Hex | Depth Est. | Confidence | Source | Notes |
|---|------|-------------|-----------|------------|--------|-------|
| **U8** | Ashfire Archipelago Sea Caves | B12 | Medium | Medium | Node 2 exploration | Volcanic island chain. The sea cave at Node 2 (Drowned Forge) had 3 chambers — bioluminescent fungus suggests deep ecosystem. Volcanic geology creates tube systems. Warden Drell's journal mentions "sounds from below the third chamber." |
| **U9** | Upper Mirren River (Node 8 area) | G7 | Shallow–Medium | Medium | Vigil Field Manual | "The River's Memory" — submerged stone in the deepest river bend. The river has carved through bedrock here. Submerged cave entrances possible. Seasonal access only (low water, late summer). |
| **U10** | Aelindra Deep Vaults | N5 | Deep | Medium | Archive records, Thessara Kain | The Grand Archive is built into a cliff face — four tiers above, unknown depth below. Thessara decoded 6 sealed site locations. Sub-level 2 was the deepest the party reached. Veyra Solund may have records of deeper construction. |
| **U11** | Southern Volcanic Island (Node 1 area) | L16 | Unknown | Medium | Vigil Field Manual | "Anchor of the Southern Deep" — volcanic island 3 days south of Veldmere. Volcanic geology = lava tubes = potential deep access. Revka/Silver Chain may have local knowledge. |

---

## Suspected Entrances (Low Confidence / Rumor)

| # | Name | Surface Hex | Depth Est. | Confidence | Source | Notes |
|---|------|-------------|-----------|------------|--------|-------|
| **U12** | Barrow of Keth-Varos (deep level) | H6 | Unknown | Low | Speculation | Sealed barrow on a hilltop. The standing stones predate surface settlements. Some barrows were built over natural cave openings. Sealed — would need to unseal to investigate. |
| **U13** | Stormcape Cliff Caves | A5–A10 | Unknown | Low | Seren (oral tradition) | Stormcape cliff-holds are built into natural caves. Grandmother Wynn's stories mention "the deep caves where the old people went." Folk memory, unverified. |
| **U14** | Duskport Harbor Seabed | K12 | Shallow | Low | Duvash (dockworker rumor) | Divers report stone structures on the harbor floor at depth. May connect to the Undercroft. Unverified. |

---

## Zaryth's Personal Knowledge (Drow)
...
## Priority Assessment (Dawnwatch Investigation)

| Priority | Entrance | Status | Notes |
|----------|----------|--------|-------|
...
## Deep Road — Surveyed Route (Day 62, 1249 AS)

**Total distance:** 30 miles (Fenhollow Station ↔ Aelindra Station)
**Walking time:** 14 days (current, unmaintained) → 5–6 days (with barge/winch, Phase 1)
**Surveyed by:** Zaryth, Mira, Bram, Aldric, Sylvara, Vaelith (Days 47–62, 1249 AS)

**Scaled map:** See `maps/underdark-scaled-map.md` for hex grid route map (A–T × 1–16, matches overworld).

### Obstacle Summary

| # | Obstacle | Location (Mi) | Solution | Est. Cost | Est. Time |
|---|----------|--------------|----------|-----------|-----------|
| 1 | Listening Dark (200-ft void) | Mi 3 | Dual winch system (iron, counterweight, rope) | 150 gp | 10 days |
| 2 | Wet Section (seasonal flood) | Mi 10 | Raised stone walkway on piers | 50 gp | 3 days |
| 3 | The Narrows (8-ft pinch) | Mi 16 | Widen to 12 ft (picks + masonry) | 30 gp | 2 days |
| 4 | The Cascade (40-ft waterfall) | Mi 26 | Bypass canal (200 ft, cut through limestone) | 80 gp | 15 days |
| **Total** | | | | **310 gp** | **30 days** |
...
|----------|----------|-------|
| Resonance stone vein | Crystal Cavern (Mi 13) | Unlimited ward materials — never run out |
| Amethyst + quartz | Crystal Cavern (Mi 13) | ~60 gp per expedition in gems |
| Sapphire (trace) | Gem Seam (Mi 24) | Rare — value TBD |
| Zurkhwood timber | Fungal Gallery (Mi 2) + Second Gallery (Mi 18) | Construction material (Underdark lumber) |
| Edible fungi (3 species) | Multiple locations | Provisions + alchemy + trade |
| Blind cave fish | River (throughout) | Protein source |
| Svirfneblin trade | Deephollow (Mi 22) | Gems ↔ surface goods |

---

## Map — Surface Entrances (Approximate)
...
```
  ...
  U13 (Stormcape cliff caves, A5-A10)
```
