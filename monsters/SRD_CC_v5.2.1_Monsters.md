# SRD 5.2.1 Monsters Section

Source: `SRD_CC_v5.2.1.pdf`

> Extracted from the "Monsters" rules section before "Monsters A–Z".
...
listed in this section. See “Playing the Game” for details on Bonus Actions.Reactions
