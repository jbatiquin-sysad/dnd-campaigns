...
**Terrain-Flavored Events:** When rolling random events, flavor results to match current terrain/environment:
- Coastal: storms, tidal events, sea creatures, shipwrecks, flotsam
- Volcanic: eruptions, gas vents, lava flows, tremors, obsidian finds
- Dead Zone: entity incursions, reality distortion, necrotic surges, ward fluctuations
- Mountain/Highland: avalanche, altitude sickness, griffon encounters, exposed ruins
- Urban: faction moves, market shifts, political events, crime, festivals
- Marsh/River: flooding, fog, quicksand, river creatures, lost travelers
